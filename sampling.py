...
def setup_schedule():
    schedule.clear()
    schedule.every().day.at(random_time(morning_peak)).do(scrap_data)
    schedule.every().day.at(random_time(inter_peak)).do(scrap_data)
    schedule.every().day.at(random_time(evening_peak)).do(scrap_data)
    schedule.every().day.at(random_time(off_peak)).do(scrap_data)
